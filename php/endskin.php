...
function phpsum($a=100, $b=null, $c=-1)
{
	$t = _phpsum($a,$b,$c);
	echo lang($t);
}
...
function lang($t)
{
	...
	$len = strlen($arr[0]);
	$t = 'هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا الن للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقطهذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا الن للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقطهذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا الن للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقطهذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا الن للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقطهذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا الن للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقطهذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا الن للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقطهذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا الن للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقطهذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا الن للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط. هذا النص للتجربة فقط';
...
class EndSkin
{
	...
	private function _compile($template)
	{
		...
		//替换阿拉伯字符
		if (preg_match_all('/\{\{(.*?)\}\}/',$page,$ms))
		{
			foreach($ms[1] as $cnt=>$tag)
			{
				$l = lang($tag);
				$page = str_replace($ms[0][$cnt],$l,$page);
			}
		}
